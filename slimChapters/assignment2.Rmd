...
initialize(){
  // Start with a high recombination rate
	...
	initializeSex("A"); // allow sex in this mutation 
}
...
Soft sweeps acting on standing variation are often caused by changes in environmental pressures. Sometimes an these changes are permanent - for example, migration into a new environment. Often, however, they are transient - e.g. a disease, or a drought. Let's model a temporary change in environmental conditions
